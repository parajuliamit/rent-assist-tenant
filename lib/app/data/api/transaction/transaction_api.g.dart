...
class _TransactionApi implements TransactionApi {
  ...
  @override
  Future<void> makeTransaction(request) async {
    ...
    await _dio.fetch<void>(_setStreamType<void>(
        Options(method: 'POST', headers: _headers, extra: _extra)
            .compose(_dio.options, '/api/payment/',
  ...
  Future<TransactionList> getTransactions() async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<TransactionList>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(_dio.options, '/api/payment/my-transactions',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
